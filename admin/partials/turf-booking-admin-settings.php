    ...
    <div class="tb-settings-container">
        <form method="post" action="options.php">
            <?php if ($active_tab == 'general') : ?>
                <?php settings_fields('tb_general_settings'); ?>
                <?php do_settings_sections('tb_general_settings'); ?>
            ...
            <?php elseif ($active_tab == 'payment') : ?>
                <?php settings_fields('tb_payment_settings'); ?>
                <?php do_settings_sections('tb_payment_settings'); ?>
            ...
            <?php elseif ($active_tab == 'email') : ?>
                <?php settings_fields('tb_email_settings'); ?>
                <?php do_settings_sections('tb_email_settings'); ?>
            ...
            <?php elseif ($active_tab == 'pages') : ?>
                <?php settings_fields('tb_page_settings'); ?>
                <?php do_settings_sections('tb_page_settings'); ?>
...
jQuery(document).ready(function($) {
    ...
    function toggleDepositSettings() {
        ...
        if (requireFullPayment) {
            $('#tb_deposit_amount').closest('tr').hide();
            $('input[name="tb_payment_settings[deposit_type]"]').closest('tr').hide();
        } else {
            $('#tb_deposit_amount').closest('tr').show();
            $('input[name="tb_payment_settings[deposit_type]"]').closest('tr').show();
        }
    }
