...
<div class="tb-court-card">
    <div class="tb-court-card-image">
        ...
        <?php if ($sport_types) : ?>
            <div class="tb-court-card-category">
                <?php echo esc_html($sport_types[0]->name); ?>
            </div>
        <?php endif; ?>
    </div>
    ...
    <div class="tb-court-card-content">
        ...
        <div class="tb-court-card-excerpt">
            <?php
        ...
        <div class="tb-court-card-footer">
            ...
            <a href="<?php the_permalink(); ?>" class="tb-button-link"><?php _e('Book Now', 'turf-booking'); ?></a>
        </div>
    </div>
</div>